...
== Changelog ==
	...
	1.0.9 - July 03, 2020
	    * Fixed: search form markup to make compatible with parent accessibility js

	1.0.8 - June 17, 2020
	    * Fixed: responsive accesibility issues

	1.0.7 - February 10, 2020
	    * Fixed: responsive design issues

	1.0.6 - October 22, 2019
		* Fixed: menu toggle arrow issue
	...
	1.0.4
		Fixed
		* issue of slider auto feature

		Improved
	    * added class when no post found
    ...
    * fix fallback svg issue
	...
	1.0.2
	* Fixed dynamic color issues and minor design improvement

	1.0.1
	* Fixed search button issue in the header
